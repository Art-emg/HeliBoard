...
import helium314.keyboard.settings.screens.createCustomExtensionsSettings
...
private fun createSettings(context: Context) = createAboutSettings(context) + createAppearanceSettings(context) +
        ...
        createLayoutSettings(context) + createAdvancedSettings(context) + createCustomExtensionsSettings(context) +
