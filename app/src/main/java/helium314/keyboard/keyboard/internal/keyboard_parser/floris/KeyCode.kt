...
object KeyCode {
    ...
    const val TOGGLE_SONIOX_STRIP_PUNCTUATION = -246
    const val SET_SONIOX_KEEP_PUNCTUATION =   -247
    const val SET_SONIOX_STRIP_PUNCTUATION =  -248
    ...
    fun Int.checkAndConvertCode(): Int = if (this > 0) this else when (this) {
        ...
        CLIPBOARD_SELECT_WORD, TOGGLE_INCOGNITO_MODE, TOGGLE_AUTOCORRECT, TOGGLE_SONIOX_STRIP_PUNCTUATION,
        SET_SONIOX_KEEP_PUNCTUATION, SET_SONIOX_STRIP_PUNCTUATION,
        MOVE_START_OF_LINE, MOVE_END_OF_LINE,
